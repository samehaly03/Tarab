...
- (NSString *)message
{
    ...
    if (!message)
    {
        message = (self.appStoreGenreID == iRateAppStoreGameGenreID)? [self localizedStringForKey:iRateGameMessageKey withDefault:@"لو اعجبك تطبيق %@ فضلا اضف تقييم للتطبيقفي اقل مندقيقة"]: [self localizedStringForKey:iRateAppMessageKey withDefault:@"لو اعجبك تطبيق %@ فضلا اضف تقييم للتطبيقفي اقل مندقيقة"];
    }
...
{
    return _cancelButtonLabel ?: [self localizedStringForKey:iRateCancelButtonKey withDefault:@"لا شكرا"];
}

- (NSString *)rateButtonLabel
{
    return _rateButtonLabel ?: [self localizedStringForKey:iRateRateButtonKey withDefault:@"موافق"];
}

- (NSString *)remindButtonLabel
{
    return [_remindButtonLabel length]? _remindButtonLabel: [self localizedStringForKey:iRateRemindButtonKey withDefault:@"ربما في وقت اخر"];
}
